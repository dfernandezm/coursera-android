...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private static final String IMAGE_FILENAME = "imageFilename";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			imageFilename = savedInstanceState.getString(IMAGE_FILENAME);
			videoFilename = savedInstanceState.getString(VIDEO_FILENAME);
			fragment = (CreateStoryFragment) getSupportFragmentManager().findFragmentById(android.R.id.content);
		}
	}
	...
	public void onSaveInstanceState(Bundle bundle) {
	 ...
	 bundle.putString(IMAGE_FILENAME, imageFilename);
	...
	private void launchCameraIntent() {
		...
		fragment.setImagePath(imageUri);
	...
	private void launchVideoCameraIntent() {
		...
		fragment.setVideoPath(Uri.fromFile(videoFile));
